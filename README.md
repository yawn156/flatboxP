...
This fork is for a flatbox rev5 build with RGB and OLED, first I'm looking into diy SMD soldering to cut costs. 
As of now the gerber uploaded has a board with working oled, but rgb lightning needs a revision.
Will update when I have a functional build with the features mentioned above.
